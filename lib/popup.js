...
function initExtension() {
  ...
  text.innerHTML = "Click on a template to rearrange your open tabs in the desired arrangement.<br> If you have less tabs open than the template requires, the template will be filled with new tabs.<br> Click on a favorite to open the arrangement of your favorite sites.<br>Clicking on the logo will recoll;ect your tabs into a single window.";
